...
NS_TEMP=$(tempfile -p kotavillagenet -m 0644)
NS_CONF=/etc/dnsmasq.d/01-kotavillagehotspot
...
checkfornew() {
    update_new_file $NS_TEMP $NS_CONF && {
        echo "New KOTAVILLAGE Network Settings. Restart services";
...
###
[ -e /usr/share/kotavillage/www/radmin/networksettings.dnsmasq.php ] && {
  php /usr/share/kotavillage/www/radmin/networksettings.dnsmasq.php > $NS_TEMP
